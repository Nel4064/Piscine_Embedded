...
{
	uart_tx("0123456789abcdef"[(value & 0xF0000000) >> 28]);
	uart_tx("0123456789abcdef"[(value & 0x0F000000) >> 24]);
	uart_tx("0123456789abcdef"[(value & 0x00F00000) >> 20]);
	uart_tx("0123456789abcdef"[(value & 0x000F0000) >> 16]);
	uart_tx("0123456789abcdef"[(value & 0x0000F000) >> 12]);
	uart_tx("0123456789abcdef"[(value & 0x00000F00) >> 8]);
	uart_tx("0123456789abcdef"[(value & 0x000000F0) >> 4]);
	uart_tx("0123456789abcdef"[(value & 0x0000000F) >> 0]);
}
